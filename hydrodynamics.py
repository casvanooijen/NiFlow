...
def load_hydrodynamics(name, solution_format='npy', parent_hydro=None, forcing_instruction=None):
    ...
    Arguments:
        ...
        - parent_hydro: parent Hydrodynamics object if you are loading a decomposition.
    ...
    if parent_hydro is not None:
        hydro = DecomposedHydrodynamics(parent_hydro, forcing_instruction)
    else:
